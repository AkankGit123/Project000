...
public class MarksheetForm extends BaseForm
{
	...
	//@Min(0)
	//@Max(100)
	@Pattern(regexp ="^(0|[1-9][0-9]?|100)$", message="{Pattern.form.maths}")
	...
	//@Min(0)
	//@Max(100)
	@Pattern(regexp ="^(0|[1-9][0-9]?|100)$", message="{Pattern.form.physics}")
	private String physics;
	
	/** chemistryMarks of Marksheet. */
	@NotEmpty
	@Pattern(regexp ="^(0|[1-9][0-9]?|100)$", message="{Pattern.form.chemistry}")
